...
if uploaded_file is not None:
    ...
    proba_df = pd.DataFrame(
        {
            ...
            * 100,  # Wahrscheinlichkeiten in Prozent
        }
    ).sort_values(
        "Wahrscheinlichkeit (%)", ascending=False
    ...
    if top_rasse["Wahrscheinlichkeit (%)"] < 30:
        ...
        st.write(
            f"Mit einer Wahrscheinlichkeit von **{top_rasse['Wahrscheinlichkeit (%)']:.2f}%**"
        )
        ...
        ax.legend(
            labels,
            title="Rassen & Wahrscheinlichkeiten",
            loc="center left",
